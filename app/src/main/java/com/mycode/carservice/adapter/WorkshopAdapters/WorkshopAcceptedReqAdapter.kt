...
class WorkshopAcceptedReqAdapter(private var acceptedReqList: List<AcceptedReqWorkshop> )
    : RecyclerView.Adapter<WorkshopAcceptedReqAdapter.MyHolderAcceptedRequests>() {
    ...
    fun updateTransportersList(newAcceptedReqWorkshop:List<AcceptedReqWorkshop>)
    {
        acceptedReqList = newAcceptedReqWorkshop
