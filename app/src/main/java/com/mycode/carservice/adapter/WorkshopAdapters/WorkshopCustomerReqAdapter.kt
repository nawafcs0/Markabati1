...
class WorkshopCustomerReqAdapter(private var customerReqList: List<CustomerReqWorkshop> )
    : RecyclerView.Adapter<WorkshopCustomerReqAdapter.MyHolderCustomerRequests>() {
    ...
    fun updateTransportersList(newCustomerReqWorkshop:List<CustomerReqWorkshop>)
    {
        customerReqList = newCustomerReqWorkshop
