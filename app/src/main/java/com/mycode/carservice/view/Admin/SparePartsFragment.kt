...
class SparePartsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_spare_parts2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btn = view.findViewById<Button>(R.id.admin_addSpare)
        btn.setOnClickListener {
            loadFragment(AddSparePartsFragment())
        }
        recyclerView=view.findViewById(R.id.admin_sparePartsRv)
        recyclerView.layoutManager=layoutManager
        recyclerView.setHasFixedSize(true)
        adapter= SparePartsAdapter(sparePartsList)
        recyclerView.adapter=adapter
        searchView = view.findViewById(R.id.admin_spareParts_searchView)
